...
public class Setting_deleted_users extends Fragment
{
    View view;

    Toolbar toolbar_setting_deleted_users;

    TextView count_all_users, count_students_all_users, count_teachers_all_users, count_delete_users_all_users;

    RecyclerView recyclerview_setting_deleted_users_students, recyclerview_setting_deleted_users_teachers;

    //загрузка анимация
    private SpinKitView progressBar;
    LinearLayout no_internet_setting_deleted_users;
    ...
    {
        view = inflater.inflate(R.layout.setting_deleted_users, container, false);

        // Устанавливаем название института в Toolbar
        toolbar_setting_deleted_users = view.findViewById(R.id.toolbar_setting_deleted_users);
        AppCompatActivity activity = (AppCompatActivity) getActivity();
        activity.setSupportActionBar(toolbar_setting_deleted_users);
        // Добавление кнопки "Назад"
        ActionBar actionBar = activity.getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        // Обработчик нажатия на кнопку "Назад"
        toolbar_setting_deleted_users.setNavigationOnClickListener(v ->
        {
        ...
        //загрузка анимация
        progressBar = view.findViewById(R.id.progress_bar_setting_deleted_users);
        ...
        count_delete_users_all_users = view.findViewById(R.id.count_delete_users_all_users);

        //показать всех польователей
        recyclerview_setting_deleted_users_students = view.findViewById(R.id.recyclerview_setting_deleted_users_students);
        recyclerview_setting_deleted_users_teachers = view.findViewById(R.id.recyclerview_setting_deleted_users_teachers);

        //нет интернета
        no_internet_setting_deleted_users = view.findViewById(R.id.no_internet_setting_deleted_users);
        ...
        else
        {
            ...
            no_internet_setting_deleted_users.setVisibility(View.VISIBLE);
    ...
    private void initRecyclerViews()
    {
        ...
        recyclerview_setting_deleted_users_students.setLayoutManager(new LinearLayoutManager(requireContext()));
        recyclerview_setting_deleted_users_students.setAdapter(usersStudentsAdapter);
        ...
        recyclerview_setting_deleted_users_teachers.setLayoutManager(new LinearLayoutManager(requireContext()));
        recyclerview_setting_deleted_users_teachers.setAdapter(usersTeachersAdapter);
    }
    ...
    private void initDatabaseReferences()
    {
        try
        {
            ...
            databaseReferenceStudents = databaseReference.child(DELETED).child(STUDENT);
            databaseReferenceTeachers = databaseReference.child(DELETED).child(TEACHER);
        ...
        try
        {
            ...
            databaseReferenceStudents.addValueEventListener(new ValueEventListener()
            {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                {
                    ...
                    count_delete_users_all_users.setText(String.valueOf(deletedUserCount));
                }
        ...
        internetCheckTimer.scheduleAtFixedRate(new TimerTask()
        {
            ...
            public void run()
            {
                ...
                if (isInternetAvailable())
                {
                    ...
                    getActivity().runOnUiThread(() -> no_internet_setting_deleted_users.setVisibility(View.GONE));
